...
steps:
  read-potential-cases-fhir:
    ...
    in:
      inputModule:
        id: inputModule
        source: inputModule1
  chronic-kidney-disease-ckd-albuminuria---primary:
    run: chronic-kidney-disease-ckd-albuminuria---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  chronic-kidney-disease-ckd-proteinuria---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: chronic-kidney-disease-ckd-albuminuria---primary/output
